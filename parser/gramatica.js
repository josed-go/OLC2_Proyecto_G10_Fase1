...
function peg$parse(input, options) {
  ...
  var peg$e21 = peg$classExpectation(["_", ["a", "z"]], false, true);
  var peg$e22 = peg$classExpectation(["_", ["a", "z"], ["0", "9"]], false, true);
  ...
  function peg$parsegramatica() {
    ...
    s0 = peg$currPos;
    s1 = peg$parse_();
    s2 = peg$parseproducciones();
    if (s2 !== peg$FAILED) {
      s3 = [];
      s4 = peg$currPos;
      s5 = peg$parse_();
      s6 = peg$parseproducciones();
      if (s6 !== peg$FAILED) {
        s5 = [s5, s6];
        s4 = s5;
      } else {
